...
var describeComponentFrame = function (name, source, ownerName) {
  ...
  if (source) {
    ...
    var fileName = path.replace(BEFORE_SLASH_RE, '');
    {
      ...
      // prefer "folder/index-child-theme.js" instead of just "index-child-theme.js".
...
function FiberNode(tag, pendingProps, key, mode) {
  ...
  if (enableProfilerTimer) {
    ...
    // Fortunately this only impacts DEV build.
...
// The following attributes are only used by interaction tracing build.
...
// Profiling properties are only safe to access in profiling build (when enableSchedulerTracing is true).
