...
function createRunHook(hooks, returnFirstArg) {
  ...
  return function runHooks(hookName) {
    ...
    hooks[hookName].runs++;
    var handlers = hooks[hookName].handlers; // The following code is stripped from production build.
...
// CONCATENATED MODULE: ./node_modules/@wordpress/hooks/build-module/index-child-theme.js
